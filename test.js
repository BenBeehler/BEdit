...
ipcMain.on('reqfname', (event, arg) => {
  event.sender.send('sendfname', this.file)
})

ipcMain.on('update', (event, arg) => {
  event.sender.send('update', 'Editing: ' + this.file + '   |   Theme: ' + theme + "   |   Language: " + language)
})
      ...
      submenu: [
        ...
        },
        {
          ...
          click() {
            op("Open", "File Path:", (r) => {
              this.file = r
              console.log(this.file + " " + r)
              mainWindow.webContents.send( 'open', fs.readFileSync(this.file) )
            })
          }
        }
      ]
